...
<body>
  ...
  <div class="modal-dialog" role="document">
	...
	<div class="row my-3 mx-1">
		<div class="col-4">
			<ul class="list-group">
				<li class="list-group-item active">Физические лица</li>
...
<a class="btn btn-warning <?php if(strcmp($_SESSION['username'],'supply_manager')==0) echo 'disabled' ?> " href="privSupplier.php?edit=<?= $supplier->getId() ?>"  role="button"  >Редактировать</a>
<a class="btn btn-danger <?php if(strcmp($_SESSION['username'],'supply_manager')==0) echo 'disabled' ?>" href="privSupplier.php?delete=<?= $supplier->getId() ?>" role="button" >Удалить</a>
<?php
}
catch (Exception $e)
{
...
if (isset($_GET['new']))
 	{?>
 		<form action="privSupplier.php" method="post">
			<div class="form-group row">
		<label for="supplierName" class="col-sm-3 col-form-label">Поставщик</label>
		<div class="col-sm-9">
...
?><a class="btn btn-success  <?php if(strcmp($_SESSION['username'],'supply_manager')==0) echo 'disabled' ?>" href="privSupplier.php?new" role="button">Новый поставщик</a><?php
 	}
 }
}
if (isset($_GET['delete']))
 {
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Вы действительно хотите удалить информацию о поставщике <?=$name->getName()?> как о физическом лице?</p>
      </div>
